    ...
    var BaseField = /** @class */ (function () {
        function BaseField() {
            ...
            this.invoke = function (name) {
                ...
                return (_b = (_a = _this.actions)[name]) === null || _b === void 0 ? void 0 : _b.call.apply(_b, __spreadArray([_a], __read(args)));
            };
        }
            ...
            if (GlobalState.effectStart) {
                GlobalState.lifecycles.push(new LifeCycle(type, function (payload, ctx) {
                    if (Formily.Shared.isFn(callback)) {
                        callback.apply(void 0, __spreadArray([payload, ctx], __read(GlobalState.context))).apply(void 0, __spreadArray([], __read(args)));
                    }
                }));
            }
            else {
        ...
        function ArrayField(address, props, form, designable) {
            ...
            _this.insert = function (index) {
                ...
                return Formily.Reactive.action(function () {
                    ...
                    (_a = _this.value).splice.apply(_a, __spreadArray([index, 0], __read(items)));
                    return _this.onInput(_this.value);
                });
            };
            ...
            _this.unshift = function () {
                ...
                return Formily.Reactive.action(function () {
                    ...
                    (_a = _this.value).unshift.apply(_a, __spreadArray([], __read(items)));
                    return _this.onInput(_this.value);
                });
            };
